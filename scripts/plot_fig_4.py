...
def sine_slope_null(k_dna, k_rna, sigma_dna, sigma_rna, n_iter = int(1e4)):
    ...
    for n in range(n_iter):
        ...
        slope, intercept, r_value, p_value, std_err = stats.linregress(diff_rna, diff_dna)
...
print(stats.linregress(clr_afd_dna[1:] - clr_afd_dna[:-1], clr_afd_rna[1:] - clr_afd_rna[:-1])[0])
