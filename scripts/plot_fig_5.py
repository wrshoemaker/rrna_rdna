...
ax_scatter.set_xlabel("CLR-transformed abund., RNA - DNA", fontsize=10)
ax_scatter.set_ylabel("Change in CLR DNA betweeen timepoints", fontsize=10)
...
ax_sine_null.set_xlabel("Slope between CLR RNA - CLR DNA at time " + r'$t$' + '\nand CLR DNA at time ' r'$t+1$', fontsize=10)
